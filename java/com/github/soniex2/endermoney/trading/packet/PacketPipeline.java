...
public class PacketPipeline extends
	...
	public PacketPipeline(String chan) {
		this.chan = chan;
	}
	...
	public boolean registerPacket(Class<? extends AbstractPacket> clazz) {
		if (this.packets.size() > 256) {
			throw new IllegalStateException("Packet list full!");
		}

		if (this.packets.contains(clazz)) {
			FMLLog.severe("Attempt to add packet %s twice. Ignoring.",
	...
	public void initialize() {
		this.channels = NetworkRegistry.INSTANCE.newChannel(chan, this);
	}
